 ...
 */
class ArticleRepositoryEloquent extends BaseRepository implements ArticleRepositoryInterface
{
    /**
    ...
    public function getAll($columns = ['*'])
    {
        ...
        foreach ($list as $key => $value) {
            $list[$key]['button'] = $this->model->getActionButtons('articles',$value['id']);
        }
        return $list;
    }
