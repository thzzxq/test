        ...
        <div class="login login-with-news-feed">
            ...
            <div class="news-feed">
                <div class="news-image">
                    <img src="<?php echo e(asset('asset_admin/assets/img/login-bg/bg-5.jpg')); ?>" data-id="login-cover-image" alt="" />
                </div>
                ...
                <div class="login-content">
                    ...
                    <form action="<?php echo e(url('admin/login')); ?>" method="POST" class="margin-bottom-0">
                        ...
                        <div class="form-group m-b-15">
                            <input type="text" name="name" class="form-control input-lg" placeholder="用户名" value="<?php echo e(old('name')); ?>"/>
                        </div>
                        <div class="form-group m-b-15">
