...
<?php $__env->startSection('admin-content'); ?>
    <div id="content" class="content">
        ...
        <button type="" onclick="getPage(this);"></button>
        <!-- end page-header -->
        <!-- begin row -->
        <div class="row">
            <!-- begin col-6 -->
            <div class="col-md-12">
                ...
                <div class="panel panel-inverse" data-sortable-id="table-basic-5">
                    ...
                    <div class="panel-body">
                        ...
                        <a href="<?php echo e(url('admin/adminuser/create')); ?>">
...
<?php $__env->startSection('admin-js'); ?>
    ...
    <script src="<?php echo e(asset('asset_admin/js/adminuser.list.js')); ?>"></script>
    <script>
        $(function(){
