            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-inverse" data-sortable-id="form-validation-1">
                    ...
                    <div class="panel-body panel-form">
                        <form class="form-horizontal form-bordered" data-parsley-validate="true" action="<?php echo e(url('admin/menus/'.$menu['id'])); ?>" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" type="text" name="name" placeholder="菜单名称" data-parsley-required="true" data-parsley-required-message="请输入菜单名称" value="<?php echo e($menu['name']); ?>"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-4 col-sm-4" for="url">菜单链接 * :</label>
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" type="text" name="url" placeholder="菜单链接" data-parsley-required="true" data-parsley-required-message="请输入菜单链接" value="<?php echo e($menu['url']); ?>"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-4 col-sm-4" for="slug">权限名称 * :</label>
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" type="text" name="slug" placeholder="权限名称" data-parsley-required="true" data-parsley-required-message="请输入权限名称" value="<?php echo e($menu['slug']); ?>"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-4 col-sm-4" for="icon">菜单图标 * :</label>
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" type="text" name="icon" placeholder="菜单图标" value="<?php echo e($menu['icon']); ?>"/>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <select class="form-control selectpicker"
                                        ...
                                        <option value="0" <?php if($menu['parent_id'] == 0): ?> selected="selected" <?php endif; ?>>顶级菜单</option>
                                        <?php foreach($topMenus as $value): ?>
                                        <option value="<?php echo e($value->id); ?>" <?php if($value->id == $menu['parent_id']): ?> selected="selected" <?php endif; ?>><?php echo e($value->name); ?></option>
                                        <?php endforeach; ?>
                                    </select>
