...
@section('admin-content')
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ url('admin/article') }}" method="post" id="form_new" enctype="multipart/form-data" >
            <!--  {{ csrf_field() }} -->
  ...
  <div class="modal fade" id="modal-edit">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ url('admin/article/5') }}" method="post" id="form_new" enctype="multipart/form-data" data-parsley-validate="true">
             {{ method_field('PATCH') }}
                <div class="modal-body clearfix">
...
@section('admin-js')
    ...
    <script type="text/javascript" src="{{ asset('asset_admin/assets/plugins/bootstrap-datetimepicker/js/bootstrap-datetimepicker.js') }}"></script>
    <script type="text/javascript" src="{{ asset('asset_admin/assets/plugins/bootstrap-datetimepicker/js/bootstrap-datetimepicker.min.js') }}"></script>
    <script type="text/javascript" src="{{ asset('asset_admin/assets/plugins/bootstrap-datetimepicker/js/locales/bootstrap-datetimepicker.zh-CN.js') }}" charset="UTF-8"></script>
    <script>
        $(function(){
