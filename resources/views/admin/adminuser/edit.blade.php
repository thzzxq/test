                    ...
                    <div class="panel-body panel-form">
                        <form class="form-horizontal form-bordered" data-parsley-validate="true" action="{{ url('admin/adminuser/'.$userData['user']['id']) }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" type="text" name="old_password" placeholder="密码" data-parsley-required="true" data-parsley-required-message="请输原密码"  data-parsley-length="[6,12]" data-parsley-length-message="密码长度6~12字符" value="{{ old('old_password') }}"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-4 col-sm-4" for="password">新密码 * :</label>
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" id="password" type="text" name="password" placeholder="密码" data-parsley-required-message="请输新密码" data-parsley-required="true" data-parsley-length="[6,12]" data-parsley-length-message="密码长度6~12字符" value="{{ old('password') }}"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-4 col-sm-4" for="password">确认密码 * :</label>
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" type="text" name="password_confirmation" placeholder="确认密码" data-parsley-length="[6,12]" data-parsley-required="true" data-parsley-required-message="请输确认密码"  data-parsley-length-message="密码长度6~12字符" data-parsley-equalto="#password" data-parsley-equalto-message="两次密码输入不一致" value="{{ old('password_confirmation') }}"/>
                                </div>
                            </div>
