...
@section('admin-css')
<link href="{{ asset('asset_admin/assets/plugins/nestable/nestable.css') }}" rel="stylesheet" type="text/css">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
             ...
             <form class="form" role="form" method="post" action="{{route('category.store')}}" id="form_new" enctype="multipart/form-data" data-parsley-validate="true" >
...
@section('admin-js')
 <script src="{{ asset('asset_admin/assets/plugins/nestable/jquery.nestable.js') }}"></script>
